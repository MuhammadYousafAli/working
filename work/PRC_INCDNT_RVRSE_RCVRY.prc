CREATE OR REPLACE PROCEDURE MWX_KASHF_DEV.PRC_INCDNT_RVRSE_RCVRY (
    P_CLNT_SEQ              NUMBER,
    P_INCDNT_DT             DATE,
...
BEGIN
    ...
    LOOP
        ...
        UPDATE MW_RCVRY_TRX RCH
           SET RCH.DEL_FLG = 1,
               ...
               RCH.CHNG_RSN_CMNT =
                      'REVERSE DUE TO INCIDENT PROCESS DATED: '|| TO_DATE (SYSDATE)
    ...
    LOOP
            ...
            THEN
                ...
                KASHF_REPORTING.PRO_LOG_MSG (
                    'PRC_INCDNT_RVRSE_RCVRY',
                       'JV NOT FOUND-FOR INCIDENT REVERSAL ==> P_CLNT_SEQ='
                    || P_CLNT_SEQ
                    || SQLERRM);
                P_INCDNT_RTN_MSG :=
        ...
        -----------  IF REVERSAL JV CREATED ALREADY ----------        
        SELECT COUNT (1)
        ...
        ELSE
            ...
            THEN
                ...
                THEN
                    ...
                    KASHF_REPORTING.PRO_LOG_MSG (
                        'PRC_INCDNT_RVRSE_RCVRY',
                           'ISSUE IN JV CREATION CLNT==> P_CLNT_SEQ='
                        || P_CLNT_SEQ
                        || SQLERRM);
                    P_INCDNT_RTN_MSG :=
